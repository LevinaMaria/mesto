export class Api {
  ...
  setUserAvatar(userData) {
    return fetch(
      "https://mesto.nomoreparties.co/v1/cohort-46/users/me/avatar",
      {
        method: "PATCH",
        headers: this._headers,
        body: JSON.stringify({
  ...
  deleteCard(cardId) {
    return fetch(
      `https://mesto.nomoreparties.co/v1/cohort-46/cards/${cardId}`,
      {
        method: "DELETE",
        headers: this._headers,
      }
  ...
  putLike(cardId, currentUser) {
    return fetch(
      `https://mesto.nomoreparties.co/v1/cohort-46/cards/${cardId}/likes`,
      {
        method: "PUT",
        headers: this._headers,
        body: JSON.stringify({
